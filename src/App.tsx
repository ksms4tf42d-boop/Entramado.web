...
import { Plus, Grid3x3, Calendar, FolderOpen, LogOut, FileText, X, Search } from 'lucide-react';
...
type View = 'grid' | 'calendar' | 'folders';
  ...
  return (
    <DynamicBackground colors={postColors}>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        {!loading && filteredPosts.length === 0 && view !== 'folders' && (
          <div className="text-center py-12">
